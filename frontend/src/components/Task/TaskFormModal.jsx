...
export default function TaskFormModal({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-50 flex items-center justify-center py-10 px-4 bg-black/20 dark:bg-black/50 backdrop-blur-sm animate-in"
      onClick={onClose}
    >
      <div
        className="bg-(--surface) rounded-2xl shadow-xl w-full max-w-md p-6 relative border border-soft animate-in delay-100 overflow-y-auto max-h-screen"
