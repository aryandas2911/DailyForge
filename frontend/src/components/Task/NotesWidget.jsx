        ...
        {notes.map((note) => (
          ...
          >
            ...
            <textarea
              ...
              className={`w-full bg-transparent outline-none text-sm resize-none overflow-hidden font-medium leading-relaxed transition-all pt-0.5 pb-1 ${
                note.completed
                  ? "line-through text-slate-400 dark:text-slate-500 opacity-60 decoration-slate-300 dark:decoration-slate-700 border-b border-transparent"
                  : "text-slate-800 dark:text-slate-200 border-b border-dashed border-slate-200 dark:border-slate-800 focus:border-[#3b8ea0] dark:focus:border-[#3b8ea0]"
              }`}
