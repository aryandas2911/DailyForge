...
<div className="flex items-center justify-between gap-2 lg:gap-3 h-16 flex-nowrap">

{/* Logo Section with Hover Animation */}
<Link to={user ? "/dashboard" : "/login"} className="flex items-center gap-2 group focus:outline-none shrink-0">
<motion.div
...
<div className="hidden md:flex items-center gap-2 lg:gap-3 shrink-0 ml-auto flex-nowrap overflow-hidden">
