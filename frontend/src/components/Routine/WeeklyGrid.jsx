...
export default function WeeklyGrid({ scheduledTasks, onSaveDay, onDeleteTask, innerRef }) {
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-6 shadow-sm animate-in w-full box-border" ref={innerRef}>
      <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Weekly Schedule</h2>
