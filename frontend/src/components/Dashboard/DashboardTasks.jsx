  ...
  return (
    <div className="card w-full">
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <button
          className="text-sm text-primary hover:opacity-80 underline-offset-4 cursor-pointer transition-colors duration-200"
      ...
      {todayTasks?.length ? (
        ...
        <div className="text-sm text-muted dark:text-gray-300 text-center py-6">
          No tasks for today.
          <span
