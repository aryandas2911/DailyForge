...
const LandingPage = () => {
  return (
    ...
    "
          >
            <div className="w-14 h-14 rounded-2xl bg-[#d0f6e3] dark:bg-[#d0f6e3]/20 flex items-center justify-center mb-6 group-hover:scale-110 transition">
              <List size={28} className="text-teal-600" />
            </div>
