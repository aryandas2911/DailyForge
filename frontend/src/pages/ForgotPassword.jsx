      ...
      >
        ...
        >
          <div className="text-center space-y-2">
            <h1 className="text-4xl font-bold tracking-tight text-main">Forgot Password</h1>
            <p className="text-sm text-muted">We will send you a link to reset your password</p>
          </div>
