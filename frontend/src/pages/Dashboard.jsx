...
export default function Dashboard() {
  ...
  <div className="card p-6 sm:p-8 rounded-3xl border border-white/10 bg-white/70 dark:bg-slate-900/60 shadow-sm">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
      ...
      <h3 className="text-lg font-semibold text-main whitespace-nowrap"> Want to know more about DailyForge and about it's features? <a href="/about" className="text-primary hover:underline">About us</a></h3>
    </div>
  </div>
</section>
