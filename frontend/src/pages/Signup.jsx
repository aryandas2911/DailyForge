    ...
    <div className="auth-page-bg min-h-screen w-full flex items-center justify-center px-6 py-10 overflow-hidden relative">
      ...
      >
        <form
          ...
          className="surface-bg animate-in w-full rounded-[30px] px-8 py-10 flex flex-col gap-3 border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.7)]"
        >
          {/* Heading */}
          <div className="text-center space-y-2">
            <h1 className="text-4xl font-bold tracking-tight text-main">Create Account</h1>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="name" className="text-sm font-medium text-main">Name</label>
            <input
              type="text"
              id="name"
          ...
          {/* Confirm Password */}
          <div className="flex flex-col gap-2">
            <label htmlFor="confirmPassword" className="text-sm font-medium text-main">Confirm Password</label>
            <div className="relative">
              <input
            ...
            {errors.confirmPassword && <span className="text-red-500 dark:text-red-400 text-xs">{errors.confirmPassword}</span>}
          </div>
