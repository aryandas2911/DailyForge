    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          required
          className={`w-full px-3 py-2.5 text-sm surface-bg rounded-sm shadow-xs input-focus hover-lift ${
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <input
            ...
            placeholder="••••••••"
            required
            className={`w-full px-3 py-2.5 pr-10 text-sm surface-bg rounded-base shadow-xs input-focus hover-lift ${
      ...
      <p className="text-center text-sm text-muted">
        ...
        <Link to="/login" className="text-main font-medium cursor-pointer hover:underline transition-colors">
          Login
        </Link>
      </p>
    </form>
