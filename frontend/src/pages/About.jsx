      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={i}
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 min-h-[140px] flex items-center rounded-2xl shadow-sm transition-all duration-300 hover:border-[#3b8ea0] dark:hover:border-[#4eb7b3] hover:shadow-md group"
            >
              <p className="text-slate-700 dark:text-slate-300 text-base font-semibold leading-relaxed group-hover:text-[#3b8ea0] dark:group-hover:text-[#4eb7b3] transition-colors duration-300">
                {item}
              </p>
            </div>
          ))}
