...
const App = () => {
  return (
    <BrowserRouter>
      <Navbar />
      <main className="app-bg min-h-screen pt-15 flex justify-center items-center bg-white text-black transition-colors duration-300 dark:bg-gray-900 dark:text-white">
        <Routes>
